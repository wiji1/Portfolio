							...
							<div className="flex flex-col md:flex-row md:space-x-8">
								<div className="md:w-1/2 mb-8 md:mb-0">
									...
									<div className="space-y-4">
										...
										<div className="flex items-center">
											<FileText size={20} className="text-indigo-600 dark:text-indigo-400 mr-3"/>
											<a href="/resume.pdf" className="text-gray-800 dark:text-gray-200 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors duration-300">Download Resume</a>
										</div>
									</div>
								</div>
							</div>
